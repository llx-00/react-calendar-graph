...
function ur() {
  if (me)
    return k;
  me = 1;
  var b = Oe, S = Symbol.for("react.element"), V = Symbol.for("react.fragment"), m = Object.prototype.hasOwnProperty, F = b.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner, A = { key: !0, ref: !0, __self: !0, __source: !0 };
  function w(_, l, T) {
    ...
    if (_ && _.defaultProps)
      for (d in l = _.defaultProps, l)
        g[d] === void 0 && (g[d] = l[d]);
    return { $$typeof: S, type: _, key: y, ref: I, props: g, _owner: F.current };
  }
...
function sr() {
  return Te || (Te = 1, process.env.NODE_ENV !== "production" && function() {
    var b = Oe, S = Symbol.for("react.element"), V = Symbol.for("react.portal"), m = Symbol.for("react.fragment"), F = Symbol.for("react.strict_mode"), A = Symbol.for("react.profiler"), w = Symbol.for("react.provider"), _ = Symbol.for("react.context"), l = Symbol.for("react.forward_ref"), T = Symbol.for("react.suspense"), d = Symbol.for("react.suspense_list"), g = Symbol.for("react.memo"), y = Symbol.for("react.lazy"), I = Symbol.for("react.offscreen"), X = Symbol.iterator, Ce = "@@iterator";
    function Pe(e) {
    ...
    function Fe(e) {
      return !!(typeof e == "string" || typeof e == "function" || e === m || e === A || De || e === F || e === T || e === d || ke || e === I || we || xe || je || typeof e == "object" && e !== null && (e.$$typeof === y || e.$$typeof === g || e.$$typeof === w || e.$$typeof === _ || e.$$typeof === l || // This needs to include all possible module reference object
    ...
    function Xe(e, r, t, n, i) {
      {
        ...
        t !== void 0 && (ve(t), a = "" + t), Ge(r) && (ve(r.key), a = "" + r.key), qe(r) && (v = r.ref, Je(r, i));
        for (u in r)
    ...
    function be(e, r) {
      {
        ...
        Ee[t] = !0;
        var n = "";
        e && e._owner && e._owner !== J.current && (n = " It was passed a child from " + h(e._owner.type) + "."), C(e), c('Each child in a list should have a unique "key" prop.%s%s See https://reactjs.org/link/warning-keys for more information.', t, n), C(null);
      }
    }
    function _e(e, r) {
      {
...
const fr = H.jsx, cr = () => /* @__PURE__ */ fr("h1", { children: "hello" });
export {
  cr as default
};
